...
const CheckOut: React.FC<IProps> = () => {
  ...
  return (
    <div>
      ...
      <div className={classes.checkoutTitle}>My shopping cart</div>
      ...
      <div className={classes.cart2Btn}>
        <button className={classes.cartBtn}>CONTINUE FINDING BOOKS ONLY</button>
        <button className={classes.cartBtn}>SIGN UP FOR LEARNING</button>
      </div>
